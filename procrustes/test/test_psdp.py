...
from procrustes.psdp import psdp_opt, psdp_peng, psdp_woodgate, psdp_projgrad, psdp_fgm, psdp_partan, psdp_anfgm


# def test_psdp_anfgm_identity(n=np.random.randint(50, 100)):
#     r"""Test Projected Gradient's algorithm for PSDP with identity matrix."""
#     a = np.eye(n)
#     b = np.eye(n)
#     res = psdp_anfgm(a=a, b=b)
#     s, error = res["s"], res["error"]
#     assert_almost_equal(s, np.eye(n))
#     assert_almost_equal(error, 0.0)


# def test_psdp_anfgm_diagonal():
...
# def test_psdp_anfgm_generic_square():
...
#     res = psdp_anfgm(a=a, b=b, max_iterations= 10000)
#     s, error = res["s"], res["error"]
...
# def test_psdp_anfgm_generic_non_square():
...
# def test_psdp_anfgm_non_full_rank():
...
# def test_psdp_partan_identity(n=np.random.randint(50, 100)):
#     r"""Test Projected Gradient's algorithm for PSDP with identity matrix."""
#     a = np.eye(n)
#     b = np.eye(n)
#     res = psdp_partan(a=a, b=b)
#     s, error = res["s"], res["error"]
#     assert_almost_equal(s, np.eye(n))
#     assert_almost_equal(error, 0.0)


# def test_psdp_partan_diagonal():
#     r"""Test Projected Gradient's algorithm for PSDP with diagonal matrix."""
#     a = np.diag([1, 2, 3, 4])
#     b = np.eye(4)
#     res = psdp_partan(a=a, b=b)
...
# def test_psdp_partan_generic_square():
#     r"""Test Projected Gradient's algorithm for PSDP with 2 generic square matrices."""
#     a = np.array([[1, 6, 0], [4, 3, 0], [0, 0, -0.5]])
#     b = np.array([[1, 0, 0], [0, -2, 3], [0, 2, 4]])
#     res = psdp_partan(a=a, b=b, max_iterations= 10000)
#     s, error = res["s"], res["error"]
#     actual_result = np.array(
#         [
#             [0.22351489, -0.11059539, 0.24342428],
...
# def test_psdp_partan_generic_non_square():
#     r"""Test Projected Grdient's algorithm for PSDP with 2 generic non-square matrices."""
#     a = np.array([[5, 1, 6, -1], [3, 2, 0, 2], [2, 4, 3, -3]])
#     b = np.array([[15, 1, 15 - 3, 2 + 5], [10, 5, 6, 3], [-3, 3, -3, -2 + 4]])
#     res = psdp_partan(a=a, b=b, max_iterations=10000)
...
# def test_psdp_partan_non_full_rank():
#     r"""Test Projected Gradient's algorithm for PSDP for full rank matrix."""
#     a = np.array(
#         [
#             [0.3452, -0.9897, 0.8082, -0.1739, -1.4692, -0.2531, 1.0339],
...
# def test_psdp_fgm_identity(n=np.random.randint(50, 100)):
#     r"""Test Projected Gradient's algorithm for PSDP with identity matrix."""
#     a = np.eye(n)
#     b = np.eye(n)
#     res = psdp_fgm(a=a, b=b)
#     s, error = res["s"], res["error"]
#     assert_almost_equal(s, np.eye(n))
#     assert_almost_equal(error, 0.0)


# def test_psdp_fgm_diagonal():
#     r"""Test Projected Gradient's algorithm for PSDP with diagonal matrix."""
#     a = np.diag([1, 2, 3, 4])
#     b = np.eye(4)
#     res = psdp_fgm(a=a, b=b)
...
# def test_psdp_fgm_generic_square():
#     r"""Test Projected Gradient's algorithm for PSDP with 2 generic square matrices."""
#     a = np.array([[1, 6, 0], [4, 3, 0], [0, 0, -0.5]])
#     b = np.array([[1, 0, 0], [0, -2, 3], [0, 2, 4]])
#     res = psdp_fgm(a=a, b=b, max_iterations= 10000)
#     s, error = res["s"], res["error"]
#     actual_result = np.array(
#         [
#             [0.22351489, -0.11059539, 0.24342428],
...
# def test_psdp_fgm_generic_non_square():
#     r"""Test Projected Grdient's algorithm for PSDP with 2 generic non-square matrices."""
#     a = np.array([[5, 1, 6, -1], [3, 2, 0, 2], [2, 4, 3, -3]])
#     b = np.array([[15, 1, 15 - 3, 2 + 5], [10, 5, 6, 3], [-3, 3, -3, -2 + 4]])
#     res = psdp_fgm(a=a, b=b, max_iterations=10000)
...
# def test_psdp_fgm_non_full_rank():
#     r"""Test Projected Gradient's algorithm for PSDP for full rank matrix."""
#     a = np.array(
#         [
#             [0.3452, -0.9897, 0.8082, -0.1739, -1.4692, -0.2531, 1.0339],
